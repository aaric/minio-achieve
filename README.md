...
[![Release](https://img.shields.io/badge/Release-0.1.0-informational.svg)](https://github.com/aaric/minio-achieve/releases)

> [MinIO Client Learning.](https://docs.min.io/docs/minio-quickstart-guide.html)

## 1 Deploy

|No.|Key|Value|Remark|
|:-:|---|---|---|
|1|管理平台地址|`http://127.0.0.1:9001`||
|2|管理账号|`admin`||
